      ...
      <form onSubmit={handleSearch} className="hidden md:block">
        <div className="relative">
          <input
            ...
            className="w-48 md:w-64 px-4 py-2 h-10 pl-10 bg-transparent border-b border-b-gray-300 focus:border-b-blue-400 focus:border-b-2 focus:outline-none focus:ring-0 text-gray-600 focus:text-gray-900"
          />
          <svg
